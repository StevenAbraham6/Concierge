  ...
  */
  ...
  listAllChildActivitiesByParentId: function () {
    var _ref6 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee2() {
      ...
      var conversationUrl, activityParentId, query, initialResponse, page, items, _iteratorNormalCompletion3, _didIteratorError3, _iteratorError3, _iterator3, _step3, activity;
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              ...
              _context2.next = 3;
              return this.listChildActivitiesByParentId(conversationUrl, activityParentId, query);
  ...
  listParentActivityIds: function () {
    var _ref7 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee3(conversationUrl, query) {
      var params, response;
    ...
    function listParentActivityIds(_x13, _x14) {
  ...
  listChildActivitiesByParentId: function () {
    var _ref8 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee4(conversationUrl, activityParentId, activityType) {
    ...
    function listChildActivitiesByParentId(_x16, _x17, _x18) {
  ...
  getReactionSummaryByParentId: function () {
    var _ref9 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee5(conversationUrl, activityParentId, query) {
      var _ref10, body, reactionObjects;
    ...
    function getReactionSummaryByParentId(_x19, _x20, _x21) {
   ...
   */
  _list: function () {
    var _ref11 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee6(options) {
      var _this23 = this;

      var res, list, limit, results, _iteratorNormalCompletion4, _didIteratorError4, _iteratorError4, _iterator4, _step4, result, items;
        ...
        while (1) {
          switch (_context6.prev = _context6.next) {
            ...
            case 12:
              ...
              for (_iterator4 = (0, _getIterator3.default)(results); !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
                result = _step4.value;
      ...
      }, _callee6, this, [[16, 20, 24, 32], [25,, 27, 31]]);
    }));
...
['assignModerator', 'unassignModerator'].forEach(function (verb) {
  Conversation.prototype[verb] = function submitModerationChangeActivity(conversation, moderator, activity) {
    ...
    return _promise2.default.all([convoWithUrl, moderator ? this.webex.internal.user.asUUID(moderator) : this.webex.internal.device.userId]).then(function (_ref12) {
