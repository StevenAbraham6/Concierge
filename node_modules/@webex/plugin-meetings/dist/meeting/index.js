  ...
  (0, _createClass3.default)(Meeting, [{
    ...
    value: function setRemoteStream(pc) {
      ...
      pc.ontrack = function (event) {
        ...
        _this16.mediaProperties.remoteStream = streams;
        ...
        _triggerProxy2.default.trigger(_this16, {
          ...
          stream: _util4.default.createMediaStream([_this16.mediaProperties.remoteStream.getAudioTracks()[0]])
        });
        ...
        _triggerProxy2.default.trigger(_this16, {
          ...
          stream: _util4.default.createMediaStream([_this16.mediaProperties.remoteStream.getVideoTracks()[0]])
        });

        if (_this16.mediaProperties.remoteStream.getVideoTracks()[1]) {
          _this16.mediaProperties.setRemoteShare(_util4.default.createMediaStream([_this16.mediaProperties.remoteStream.getVideoTracks()[1]]));
          _triggerProxy2.default.trigger(_this16, {
            file: 'meeting/index',
            function: 'setRemoteStream:pc.ontrack'
          }, _constants.EVENT_TRIGGERS.MEDIA_READY, {
            type: _constants.EVENT_TYPES.REMOTE_SHARE,
            stream: _this16.mediaProperties.remoteShare
          });
        }
      };
    }
